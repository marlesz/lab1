...
print ("Nazywam się Marta Leszczuk. Mój login Github to marlesz. \nTemat mojej pracy dyplomowej to: \"Kontekstowa generalizacja konturów zabudowy z wykorzystaniem narzędzi morfologii matematycznej\".")
print ("Powyższy skrypt zawiera słownik użytkowników wraz z ich ocenami poszczególnych artystów muzycznych. Zdefiniowane są w nim funkcje, które z założenia mają odpowiednio: obliczyć odległość w metryce Manhattan; wyszukać sąsiadów w oparciu o preferencje muzyczne; zwrócić rekomendacje muzyczne. Powyższe funkcje jednak aktualnie nie wykazują działania, ponieważ nie mają wpisanych instrukcji, wykonujących powyżej opisane zadania. Wynikiem uruchomienia skryptu jest wyświetlenie rekomendacii dla konkretnych użytkowników")
